...
import com.rifaqat.knowledgesharing.Activities.CommentQuestionsActivity;
...
import com.rifaqat.knowledgesharing.databinding.QuestionsSampleBinding;
...
public class QuestionAdapter extends RecyclerView.Adapter<QuestionAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View listItem = layoutInflater.inflate(R.layout.questions_sample, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String time = TimeAgo.using(model.getQuestionAt());
        holder.binding.time.setText(time);
        holder.binding.descriptionHome.setText(model.getQuestionDescription());

        //Get user data from firebase to show questions fragment like profile,name etc.
        FirebaseDatabase.getInstance()
                .getReference()
                .child("Users")
                .child(model.getQuestionBy())
        ...
        holder.binding.like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final DatabaseReference likesRef = FirebaseDatabase.getInstance().getReference()
                        .child("Likes").child(model.getQuestionId()).child("likes");
...
// Add listener to update like count in real-time
        ...
        holder.binding.comments.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, CommentQuestionsActivity.class);
                intent.putExtra("postId", model.getQuestionId());
                intent.putExtra("postedBy", model.getQuestionBy());
